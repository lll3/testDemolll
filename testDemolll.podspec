...
Pod::Spec.new do |spec|
  ...
  spec.author             = { "lll" => "467445562@qq.com" }
  # Or just: spec.author    = "lll"
  # spec.authors            = { "lll" => "467445562@qq.com" }
  # spec.social_media_url   = "https://twitter.com/lll"
  ...
  #spec.source_files  = "testDemolll", "testDemolll.framework/**/*.{h,m}"
  ...
  spec.vendored_frameworks = "testDemolll/test.framework" 
